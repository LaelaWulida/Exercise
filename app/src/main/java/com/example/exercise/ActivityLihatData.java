...
public class ActivityLihatData extends AppCompatActivity {
    TextView tvnama, tvnomor, tvDetail, tnama, tnomor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDetail=findViewById(R.id.textView7);
        tnama=findViewById(R.id.textView8);
        tnomor=findViewById(R.id.textView10);
